 ...
 * <ul>
 *   <li>{@link fr.inria.diverse.pdedependencies2dot.model.pdedependencies2dot.impl.PDEGraphImpl#getFeatures <em>Features</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PDEGraphImpl extends PluginContainerImpl implements PDEGraph {
	...
	protected EClass eStaticClass() {
		return Pdedependencies2dotPackage.Literals.PDE_GRAPH;
	}
	...
	public EList<Feature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentWithInverseEList<Feature>(Feature.class, this, Pdedependencies2dotPackage.PDE_GRAPH__FEATURES, Pdedependencies2dotPackage.FEATURE__CONTAINING_GRAPH);
		}
		return features;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pdedependencies2dotPackage.PDE_GRAPH__FEATURES:
