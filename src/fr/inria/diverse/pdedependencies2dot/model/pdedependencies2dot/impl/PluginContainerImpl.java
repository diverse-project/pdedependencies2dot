 ...
 * <ul>
 *   <li>{@link fr.inria.diverse.pdedependencies2dot.model.pdedependencies2dot.impl.PluginContainerImpl#getPlugins <em>Plugins</em>}</li>
 *   <li>{@link fr.inria.diverse.pdedependencies2dot.model.pdedependencies2dot.impl.PluginContainerImpl#getHue <em>Hue</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PluginContainerImpl extends NamedElementImpl implements PluginContainer {
	...
	protected EClass eStaticClass() {
		return Pdedependencies2dotPackage.Literals.PLUGIN_CONTAINER;
	}
	...
	public EList<Plugin> getPlugins() {
		if (plugins == null) {
			plugins = new EObjectContainmentWithInverseEList<Plugin>(Plugin.class, this, Pdedependencies2dotPackage.PLUGIN_CONTAINER__PLUGINS, Pdedependencies2dotPackage.PLUGIN__CONTAINING_ELEMENT);
		}
		return plugins;
	}
	...
	public void setHue(float newHue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pdedependencies2dotPackage.PLUGIN_CONTAINER__HUE, oldHue, hue));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pdedependencies2dotPackage.PLUGIN_CONTAINER__PLUGINS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pdedependencies2dotPackage.PLUGIN_CONTAINER__PLUGINS:
				return getPlugins();
			case Pdedependencies2dotPackage.PLUGIN_CONTAINER__HUE:
				return getHue();
		}
