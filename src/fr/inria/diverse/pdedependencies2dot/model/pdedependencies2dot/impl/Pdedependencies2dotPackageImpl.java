...
import fr.inria.diverse.pdedependencies2dot.model.pdedependencies2dot.NamedElement;
import fr.inria.diverse.pdedependencies2dot.model.pdedependencies2dot.PDEGraph;
import fr.inria.diverse.pdedependencies2dot.model.pdedependencies2dot.Pdedependencies2dotFactory;
 ...
 * @generated
 */
public class Pdedependencies2dotPackageImpl extends EPackageImpl implements Pdedependencies2dotPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass pdeGraphEClass = null;
	 ...
	 * @generated
	 */
	private EClass pluginContainerEClass = null;
	 ...
	 * @see fr.inria.diverse.pdedependencies2dot.model.pdedependencies2dot.Pdedependencies2dotPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Pdedependencies2dotPackageImpl() {
		super(eNS_URI, Pdedependencies2dotFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Pdedependencies2dotPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Pdedependencies2dotPackage init() {
		if (isInited) return (Pdedependencies2dotPackage)EPackage.Registry.INSTANCE.getEPackage(Pdedependencies2dotPackage.eNS_URI);

		// Obtain or create and register package
		Pdedependencies2dotPackageImpl thePdedependencies2dotPackage = (Pdedependencies2dotPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Pdedependencies2dotPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Pdedependencies2dotPackageImpl());
		...
		thePdedependencies2dotPackage.createPackageContents();

		// Initialize created meta-data
		thePdedependencies2dotPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		thePdedependencies2dotPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Pdedependencies2dotPackage.eNS_URI, thePdedependencies2dotPackage);
		return thePdedependencies2dotPackage;
	}
	 ...
	 * @generated
	 */
	public Pdedependencies2dotFactory getPdedependencies2dotFactory() {
		return (Pdedependencies2dotFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		pdeGraphEClass.getESuperTypes().add(this.getPluginContainer());
...
} //Pdedependencies2dotPackageImpl
